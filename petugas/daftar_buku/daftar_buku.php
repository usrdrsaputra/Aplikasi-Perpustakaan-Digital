                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex flex-column flex-md-row">
                                    ...
                                    <a href="?page=lihat_ulasan_buku&BukuID=<?php echo $data['BukuID']?>" class="btn btn-success btn-sm ms-1" style="border-radius: 5px;" title="lihat_ulasan"><i class="mdi mdi-eye-outline"></i> </a>
                                </div>
                            </td>
                        </tr>
                        <?php
