            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <select class="form-control" style="color: black;" required name="Rating">
                        ...
                        <a href="?page=lihat_ulasan_buku&BukuID=<?php echo isset($data['BukuID']) ? $data['BukuID'] : ''; ?>" class="btn btn-danger mt-4">Batal</a>
                    </form>
                </div>
...
?>
    ...
    ?>
        <script type="text/javascript">
            ...
            window.location = "index.php?page=tambah_ulasan";
        </script>
<?php
    }
}
